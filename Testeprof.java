...
public class Testeprof {
     ...
     * @since JDK 1.5
     */
    public Testeprof(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public Testeprof(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public static void main(String[] args) throws NumberFormatException {
        ...
        Testeprof teste = new Testeprof(new BigDecimal(valor));
